...
from django.urls import path
from .views import MealListCreateAPIView, MealDetailByDateAPIView, GetOrDeleteMealByidAPIView

urlpatterns = [
    path('meal/<str:username>/', MealListCreateAPIView.as_view(), name='meal-list-create'),
    path('meal/<str:username>/date/', MealDetailByDateAPIView.as_view(), name='meal-detail-by-date'),  # 날짜 기반 수정 및 삭제
    path('meal/<str:username>/<int:foodID>', GetOrDeleteMealByidAPIView.as_view(), name='meal-get-delete-by-id'),
]
